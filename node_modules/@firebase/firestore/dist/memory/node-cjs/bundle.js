...
function loadBundle(data) {
    return database4cdb5b72.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    return database4cdb5b72.namedQuery(this._delegate, queryName).then(expQuery => {
        if (!expQuery) {
            return null;
        }
        return new database4cdb5b72.Query$1(this, 
...
registerBundle(database4cdb5b72.Firestore);
