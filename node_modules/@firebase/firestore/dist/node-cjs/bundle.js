...
function loadBundle(data) {
    return databaseA359a6f0.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    var _this = this;
    return databaseA359a6f0.namedQuery(this._delegate, queryName).then(function (expQuery) {
        if (!expQuery) {
            return null;
        }
        return new databaseA359a6f0.Query$1(_this, 
...
registerBundle(databaseA359a6f0.Firestore);
